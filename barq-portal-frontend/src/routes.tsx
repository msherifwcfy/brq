...
import { CybersecurityPage, FooterPage, ItInfrastructurePage } from "./features/cms";
...
import { NewsroomCMSPage } from "./features/cms/newsroom";
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            element: (
              <ProtectedRoute permissionKey={PERMISSION_KEYS.SOLUTIONS.VIEW}>
                <SolutionListPage />
              </ProtectedRoute>
            ),
          },
