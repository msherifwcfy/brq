...
const executiveCardSchema = z.object({
...
export const createExecutiveTeamSchema = z.object({
...
export const updateExecutiveTeamSchema = z.object({
  ...
  cards: z
    .array(executiveCardSchema.extend({ id: z.number().optional() }))
    .min(1, "At least 1 card is required")
    .max(18, "Maximum 18 cards allowed (3 rows × 6 cards)")
    .optional(),
});

export type CreateExecutiveTeamFormData = z.infer<typeof createExecutiveTeamSchema>;
export type UpdateExecutiveTeamFormData = z.infer<typeof updateExecutiveTeamSchema>;
export type ExecutiveCardFormData = z.infer<typeof executiveCardSchema>;
