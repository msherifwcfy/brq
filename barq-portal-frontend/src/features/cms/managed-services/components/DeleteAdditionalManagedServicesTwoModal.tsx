...
import { useAdditionalManagedServicesTwoControllerDelete } from "@/sdk/modules/additionalmanagedservicestwo.gen";
import { toast } from "sonner";
import { Button } from "@/shared/components/ui/button";

export function DeleteAdditionalManagedServicesTwoModal() {
  const deleteMutation = useAdditionalManagedServicesTwoControllerDelete();
  const { onClose, refetch, isOpen, type, data } = useModal();
  const open = isOpen && type === "deleteAdditionalManagedServicesTwo";
