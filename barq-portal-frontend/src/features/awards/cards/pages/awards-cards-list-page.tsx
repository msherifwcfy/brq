...
import { useAwardsCardsColumns } from "../columns/awards-cards-columns";
...
const AwardsCardsListPage: React.FC = () => {
  const { t } = useLang();
  ...
  return (
    <DashboardLayout>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold">{t("awardsCards.title")}</h1>
...
export default AwardsCardsListPage;
