...
export default function CareerSuccessModal({ isOpen, onClose }: CareerSuccessModalProps) {
        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            ...
            >
                ...
                >
                    ...
                    >
                        Thank you! We&apos;ve received your information. A confirmation email will be sent to you shortly
                    </motion.p>
