...
export default function AwardsHead({ data }: AwardsHeadProps) {
  ...
  return (
    <RevealOnScroll className='mt-[138.48px] flex justify-center items-center flex-col gap-6 lg:mb-20 mb-10 px-[5%] xl:px-0'>
      ...
      <p className='text-[#D9DDDD] text -[16px] font-normal leading-[1.5] lg:leading-[24px] max-w-[90vw] sm:max-w-[500px] lg:max-w-[408px] text-center break-words overflow-wrap-anywhere'>
        {headData?.sub_title ||
