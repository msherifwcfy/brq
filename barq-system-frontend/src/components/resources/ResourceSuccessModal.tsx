...
export default function ResourceSuccessModal({ isOpen, onClose }: ResourceSuccessModalProps) {
        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            ...
            >
                ...
                >
                    ...
                    >
                        Thank you! We’ve received your registration. A confirmation email will be sent to you shortly
                    </motion.p>
