                    ...
                    <RevealOnScroll>
                        ...
                        <div className='flex-1 max-w-full lg:max-w-[652px]'>
                            ...
                            <div className=''>
                                ...
                                <ul className={`h-auto lg:h-[175px] ${isRTL ? 'pr-1 pl-0' : 'pl-1 pr-0'}`}>
                            ...
                            <div className='mt-6 lg:mt-10'>
                                <p
                                    ...
                                    className='text-[#ECEEEE] text-[16px] lg:text-[18px] h-auto lg:h-[13px] pb-4 lg:pb-6 frutiger-lt-std-bold-extra leading-[24px] lg:leading-[27px] mb-3 lg:mb-6'>
