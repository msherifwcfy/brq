...
export default function Campaign3() {
    ...
    return (
        <div className='bg-black relative overflow-hidden min-h-screen'>
            ...
            <div className='absolute top-[21%] left-[5%] w-full hidden lg:block'>
            ...
            <div className='absolute bottom-[42.3%] left-0 h-[439px] w-[141px] hidden lg:block'>
            ...
            <div className='relative z-40 max-w-7xl mx-auto px-[5%] xl:px-0'>
                ...
                <div className='mt-[120px] lg:mt-[258px]'>
                    <h2 className='text-white text-[32px] lg:text-[48px] leading-[38px] lg:leading-[52.8px] mb-8 lg:mb-12'>
                                    ...
                                    <div key={index} className='flex items-center gap-3 lg:gap-4'>
                                        ...
                                        >
                                            <Image
                                                ...
                                                width={20}
                                                height={20}
                                                className='object-contain w-[16px] lg:w-[20px] h-[16px] lg:h-[20px]'
                                            />
                                        </div>
                                        <h3
                                            style={{
                ...
                <div className='mt-[60px] lg:mt-[80px]'>
                    <h2 className='text-white text-[28px] lg:text-[48px] leading-[34px] lg:leading-[52.8px] mb-3 lg:mb-4 text-center'>
                ...
                <div className='mt-[80px] lg:mt-[116px] w-full flex flex-col lg:flex-row gap-8 lg:gap-16 items-center'>
                    <div className="relative rounded-[24px] w-full lg:w-[391px] h-auto lg:h-[389px] flex items-center justify-center">
                        <div className="relative px-4 lg:px-6 py-6 lg:py-8 w-full lg:w-[348px] flex h-[250px] lg:h-[325px]">
                ...
                <div className='mt-[100px] lg:mt-[160px]'>
                    ...
                    <div className='flex justify-center pb-[100px] lg:pb-[213px]'>
                        <Button
                            onClick={() => setIsModalOpen(true)}
                            className='z-[3000] text-white flex items-center justify-start gap-[8px] lg:gap-[10px] hover:gap-[4px] text-[16px] lg:text-[18px] h-[48px] lg:h-[56px] font-normal transition-all duration-300 rounded-[12px] academy-button'
                            style={{
                                background:
                                    'linear-gradient(95deg, var(--Secondary-Blue-100, #318CCC) 13.23%, #0040C3 81.63%)',
                                boxShadow: '4px 8px 24px 0 rgba(36, 107, 253, 0.25)',
