  ...
  return (
    <>
      <section ref={containerRef} className='relative bg-black z-[9999] '>
        <div className='w-full px-[5%] xl:px-0 max-w-7xl mx-auto bg-black'>
          ...
          <div className='relative bg-black rounded-[24px] '>
            <div className='  mb-6 w-full h-full max-h-[500px] z-[3000] bg-black rounded-[24px]'>
              <Image
                src={'/assets/accademy/academy-image.jpg'}
                alt={'academy'}
                width={2000}
                height={2000}
            ...
            >
              <div className='w-full lg:w-1/2 pl-6  pt-12 lg:pt-0 md:pl-10'>
                <motion.h3
                ...
                >
                  BARQ Academy is our talent development hub — training future
                  leaders in IT, cybersecurity, and enterprise solutions.
                </motion.p>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={isInView ? { opacity: 1, y: 0 } : { opacity: 1, y: 0 }}
                ...
                >
                  <Button
                    className='text-white  flex items-center justify-start gap-[10px] hover:gap-[4px] text-[16px] lg:text-[18px] h-[48px] lg:h-[56px] font-normal transition-all duration-300  hero-text rounded-[12px] academy-button min-w-[280px]'
                    style={{
                      background:
                  ...
                  >
                    <span className='h-[24px'>Explore BARQ Academy</span>
                    <Image
        ...
        <AwardsSection leadershipData={leadershipData} />
      </section>
      {/* <InsightsNewsSection /> */}
    </>
  );
