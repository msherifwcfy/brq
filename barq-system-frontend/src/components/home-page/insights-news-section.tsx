    ...
    >
      ...
      <div className=' hidden lg:block z-[10000]'>
        <Image
          ...
          height={514}
          width={514}
          className='absolute top-[42%] right-[0%] h-[252px] w-[266px] min-[1500px]:top-[45.2%] min-[1500px]:h-[252px] min-[1500px]:w-[306px] min-[1500px]:right-[-1%] object-cover min-[1500px]:object-contain z-20'
          alt={''}
        />
        {/* <div className="relative w-full h-full bg-gradient-to-b from-black/100 to-black/0">
                    <div
                        className="absolute  top-[54%] right-[-12%]   w-[430px] h-[430px]"
                        style={{
                            background: "linear-gradient(336deg, #B6E6F7 5.85%, #134A83 59.25%)",
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    backgroundPositionX: index == 0 ? '49%' : 'center',
