        ...
        <div className='flex flex-col lg:flex-row items-start gap-6 lg:gap-10 w-full mb-[100px] lg:mb-[189px]'>
                ...
                <div className='flex items-center gap-4 mb-4 h-auto lg:h-[24px]'>
                    <div className='mt-1 lg:w-6 lg:h-6'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 20 20" fill="none" className='lg:w-[18px] lg:h-[18px]'>
                            <path d="M1 19H19M7 6H8M7 10H8M7 14H8M12 6H13M12 10H13M12 14H13M3 19V3C3 2.46957 3.21071 1.96086 3.58579 1.58579C3.96086 1.21071 4.46957 1 5 1H15C15.5304 1 16.0391 1.21071 16.4142 1.58579C16.7893 1.96086 17 2.46957 17 3V19" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </div>
                    <div className='flex text-[#ECEEEE] text-[16px] lg:text-[18px] leading-[22px] lg:leading-[27px] font-normal'>
                        Venue: Voco Hotel KSA
                    </div>
                </div>
                {/* Address */}
                <div className='flex items-center gap-4 mb-4 h-auto lg:h-[24px]' >
                ...
                <div className='flex items-center gap-4 mb-6 h-auto lg:h-[42px]'>
                    ...
                    <div className='flex-1'>
                        <div className='text-[#ECEEEE] text-[16px] lg:text-[18px] leading-[22px] lg:leading-[27px] font-normal mb-1 max-w-full lg:max-w-[530px]'>
                            Google Maps Link : <a href="https://www.ihg.com/voco/hotels/us/en/riyadh/ruhsd/hoteldetail" target="_blank" rel="noopener noreferrer" className='text-[#ECEEEE] underline hover:text-[#DC3BEF] transition-colors break-all'>
                                https://www.ihg.com/voco/hotels/us/en/riyadh/ruhsd/hoteldetail
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div className="relative flex-1 rounded-[24px] w-full lg:w-[620px] min-h-[250px] lg:min-h-[330px] flex items-center justify-center" >
                <div className="relative p-4 w-full h-full">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3625.7521998367074!2d46.69417207580718!3d24.66665645298439!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e2f056a5648df41%3A0x7c5357ba4100cf6b!2svoco%20Riyadh%20by%20IHG!5e0!3m2!1sen!2seg!4v1760808537596!5m2!1sen!2seg"
                        width="100%"
                        height="100%"
                        style={{ border: 0 }}
                        allowFullScreen
