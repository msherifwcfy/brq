...
export default function SuccessModal({ isOpen, onClose }: SuccessModalProps) {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            ...
            />
            <DialogContent
                className=" min-w-[620px] h-[310px] p-0 overflow-hidden"
                style={{
                    borderRadius: "24px",
            ...
            >
                ...
                >
                    ...
                    {/* Title */}
                    <motion.h2
                        className="text-white text-[28px] h-[32px] lg:text-[36px] frutiger-lt-std-bold  leading-[43.2px]  text-center "
                    ...
                    {/* Description */}
                    <motion.p
                        className="text-[#ECEEEE]  h-[22px] tracking-[0.02em] text-[16px] lg:text-[18px] text-center w-full leading-[27px]"
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
