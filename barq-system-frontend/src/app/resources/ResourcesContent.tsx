                                    ...
                                    <div className='flex flex-col flex-1 mt-4 lg:mt-6 justify-between'>
                                        ...
                                        <div className=''>
                                            <button className='cursor-pointer text-[#25B8E4] flex gap-3 lg:gap-4 items-center text-[14px] lg:text-[16px] frutiger-lt-std-bold py-3 lg:py-4 mt-4 lg:mt-6'>
                                                ...
                                                <span className={`mt-[2px] ${i18n.language === "ar" ? "rotate-180" : ""}`}>
                                                    <svg
                    ...
                    <RevealOnScroll>
                        <div className='flex items-center justify-center gap-2 mt-[64px] lg:mt-[96px] pb-10 mb-[60px] lg:mb-[129.32px]'>
                            ...
                            <button
                                ...
                                className='p-3 lg:p-4 h-[40px] lg:h-[45px] w-[35px] lg:w-[45px] text-[16px] lg:text-[18px] leading-[24px] lg:leading-[27px] flex items-center justify-center rounded-[8px] border-[1px] border-[#FFFFFF29] backdrop:blur(10px) text-white disabled:text-gray-500 disabled:cursor-not-allowed hover:text-white hover:bg-[#25B8E4] disabled:bg-[#FFFFFF0A] transition-colors'
                            >
                                <div className='w-[20px] lg:w-[24px] h-[20px] lg:h-[24px]'>
                                    {
                                        currentPage === 1 ? (
                                            <svg
                                                className={`${i18n.language === "ar" ? "rotate-180" : ""} cursor-not-allowed lg:w-[24px] lg:h-[24px]`}
                                                xmlns='http://www.w3.org/2000/svg'
                                                width='20'
                                                height='20'
                                                viewBox='0 0 24 24'
                                            ...
                                            <svg
                                                className={`${i18n.language === "ar" ? "rotate-180" : ""} lg:w-[24px] lg:h-[24px]`}
                                                xmlns='http://www.w3.org/2000/svg'
                                                width='20'
                                                height='20'
                                                viewBox='0 0 24 24'
                            ...
                            <button
                                ...
                                disabled={currentPage === 1}
                                className='p-3 lg:p-4 h-[40px] lg:h-[45px] w-[35px] lg:w-[68px] text-[16px] lg:text-[18px] leading-[24px] lg:leading-[27px] flex items-center justify-center rounded-[8px] border-[1px] border-[#FFFFFF29] backdrop:blur(10px) text-white disabled:text-gray-500 disabled:cursor-not-allowed hover:text-white hover:bg-[#25B8E4] disabled:bg-[#FFFFFF0A] transition-colors'
                            >
                                <span className='block lg:hidden text-white'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="6" height="10" viewBox="0 0 8 14" fill="none">
                                        <path d="M7 1L1 7L7 13" stroke={currentPage === 1 ? "#FFFFFF80" : "white"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                    </svg>
                                </span>
                            ...
                            {(() => {
                                const renderPageButton = (page: number) => (
                                    <button
                                        ...
                                        className={`p-3 lg:p-4 h-[40px] lg:h-[45px] w-[35px] lg:w-[43px] text-[16px] lg:text-[18px] leading-[24px] lg:leading-[27px] flex items-center justify-center rounded-[8px] font-medium transition-all backdrop:blur(10px) duration-200 ${currentPage === page
                                ...
                                const renderEllipsis = (key: string) => (
                                    <button
                                        disabled={true}
                                        key={key}
                                        className={`p-3 lg:p-4 h-[40px] lg:h-[45px] w-[35px] lg:w-[43px] text-[16px] lg:text-[18px] leading-[24px] lg:leading-[27px] flex items-center justify-center rounded-[8px] font-medium transition-all backdrop:blur(10px) duration-200 bg-[#FFFFFF0A] text-white border border-[#FFFFFF29] hover:bg-[#25B8E4] hover:text-white`}
                                    >
                                        ...
                                    </button>
                                );
                            ...
                            >
                                <span className='block lg:hidden text-white'>
                                    <svg className={`${i18n.language === "ar" ? "rotate-180" : ""}`} xmlns="http://www.w3.org/2000/svg" width="6" height="10" viewBox="0 0 8 14" fill="none">
                                        <path d="M1 1L7 7L1 13" stroke={currentPage === totalPages ? "#FFFFFF80" : "white"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                    </svg>
                                </span>
                                <span className=' lg:block hidden'>
                                    {t("resources.next")}
