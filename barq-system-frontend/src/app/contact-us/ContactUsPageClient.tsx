...
const ContactUsPageClient = ({
  ...
  return (
    ...
    >
      ...
      />
      <div className='absolute top-[30%] left-[15%] right-0 bottom-0 w-full h-[830px] hidden lg:block'>
        <Image
          src='/assets/contact-us/Ellipse 6.svg'
          alt='contact-us-bg'
          width={1440}
          height={1006}
      ...
      <div className='absolute top-0 left-0 right-0 bottom-0 w-full lg:h-[830px] h-[120vh]'>
        <Image
          src='/assets/contact-us/contact-us-bg.svg'
          alt='contact-us-bg'
          width={1440}
          height={830}
      ...
      <motion.div
        ...
        dir='ltr'
      >
        <InteractiveMap officesData={officesData} />
      </motion.div>
    </motion.div>
  );
};
