...
interface AcademyApplicationContentProps {
    program: AcademyProgram;
}

const AcademyApplicationContent = ({ program }: AcademyApplicationContentProps) => {
    return (
                    ...
                    <div
                        ...
                        <div className='w-full flex flex-col lg:max-w-[546px] '>
                            ...
                            <p className='text-[#ECEEEE] text-[16px] lg:text-[18px] leading-[24px] lg:leading-[27px] tracking-[0.02em] mb-6 lg:mb-8'>
                                Learn how to design, secure, and optimize modern networks while building cybersecurity skills to protect data and prevent threats.
                            </p>
                            <div className=''>
...
export default AcademyApplicationContent
